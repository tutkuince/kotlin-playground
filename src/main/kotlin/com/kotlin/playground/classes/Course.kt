...
data class Course @JvmOverloads constructor(
    ...
    companion object {
        @JvmStatic
        fun printNameFromCompanionObject(name: String = "default") {
            println("Name is $name from Companion Object")
        }
    }
...
@JvmOverloads
@JvmName(name = "printNameFromAnnotation")
...
fun main() {
    ...
    val courseJava = CourseJava(2, "Facebook Marketing", "Utku")
    courseJava.id = 3
    courseJava.name = "Facebook Marketing 2024"
    courseJava.author = "Cigdem"
